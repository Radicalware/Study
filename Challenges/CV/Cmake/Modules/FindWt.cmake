...
FOREACH(_Wt_LIB_NAME ${Wt_LIBRARIES_REQUESTED})
  message("Finding: ${_Wt_LIB_NAME}")
  STRING(TOUPPER "${_Wt_LIB_NAME}" _Wt_LIB_VAR)
  SET(_Wt_LIB_VAR "Wt_${_Wt_LIB_VAR}_LIBRARY")
  SET(${_Wt_LIB_VAR})
  FIND_LIBRARY(${_Wt_LIB_VAR}_DEBUG ${_Wt_LIB_NAME}d HINTS ${Wt_ROOT} PATH_SUFFIXES lib bin)
  FIND_LIBRARY(${_Wt_LIB_VAR}_RELEASE ${_Wt_LIB_NAME} HINTS ${Wt_ROOT} PATH_SUFFIXES lib bin)
